<?php
	...
	$page = "editevent.php";
	if(!isset($_GET['e']) || $_GET['e'] == NULL || $_GET['e'] == 0){
	?>
	...
	<div class="Card card1">
		...
		<div class="in">
			...
			if ($session->CWID == $lead || $session->isAdmin()  && !(isset($_GET['nm']) && $_GET['nm']==1)){
				if (!isset($_GET['t'])){
				?>
					...
					<form action="process.php" method="POST" id="editeventB">
						<div class="outter">
							...
							?>
								...
								<input type="hidden" name="eventid" value="<?php echo $event; ?>">
								<input type="hidden" name="tail" value="<?php echo $tail; ?>">

							</p>
						</p>
														<div class="row col s12" style="clear:both;" >
				...
				} elseif ($session->CWID == $instructor  || (isset($_GET['nm']) && $_GET['nm']==1)){
				//Edit only notes!!!
			?>
			<div class="row col s12" >
