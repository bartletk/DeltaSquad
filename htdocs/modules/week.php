...
echo '<div class="cal_top"><a href="index.php?o=',$o,'&w=',$w,'&c=',$c,'&m=',$prev["week"]["m"],'&a=',$prev["week"]["a"],'&y=',$prev["week"]["y"],'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'">&lt;</a> ',$lang["week_of"],date('F j, Y', mktime(0,0,0,$now["week"]["m"][0],$now["week"]["a"][0],$now["week"]["y"][0])),' <a href="index.php?o=',$o,'&w=',$w,'&c=',$c,'&m=',$next["week"]["m"],'&a=',$next["week"]["a"],'&y=',$next["week"]["y"],'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'">&gt;</a></div>'."\n";
