<?php
	...
	global $sem, $studentCWID, $rm;
		...
		if(!$result || (mysql_num_rows($result) < 1)){
			...
			global $week_titles_ss, $o, $m, $a, $y, $w, $c, $next, $prev, $lm, $la, $le, $studentCWID, $rm, $cm;
		...
		/* build table */
		echo '<table width="100%" class="grid"><tr>'; 
		echo '<th colspan="7" class="cal_top_s"><a href="index.php?o=',$lm,'&w=',$w,'&c=',$c,'&m=',$calmonth,'&a=1&y=',$calyear,'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'&cm=',$cm,'">',date('F', mktime(0,0,0,$calmonth,1,$calyear)),'</a></th></tr><tr>';
		for ( $x = 0; $x < 7; $x++ )
		...
		echo '<td class="day"><div class="week"><a href="index.php?o=',$le,'&w=',$w,'&c=',$c,'&m=',$offmonth,'&a=',$offday,'&y=',$offyear,'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'&cm=',$cm,'">week</a></div></td>';
		} else {
		...
		echo '<td class="day" id="today"><div class="day_of_month_s"><a href="index.php?o=',$la,'&w=',$w,'&c=',$c,'&m=',$calmonth,'&a=',$d,'&y=',$calyear,'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'&cm=',$cm,'">', $d, '</a></div>';
		} else {
		echo '<TD class="day"><div class="day_of_month_s"><a href="index.php?o=',$la,'&w=',$w,'&c=',$c,'&m=',$calmonth,'&a=',$d,'&y=',$calyear,'&sem=',$sem,'&cwid=',$studentCWID,'&rm=',$rm,'&cm=',$cm,'">', $d, '</a></div>';
