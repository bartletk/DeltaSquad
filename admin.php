				...
				<div class="row">
						...
						<form action="adminprocess.php" method="POST">
							<div class="row">
								...
								<div class="row">
									...
									<div class="input-field col s12">
										<input id="username" type="text" class="validate"  name="user" maxlength="30" required value="<?php echo $form->value("user"); ?>"><?php echo $form->error("user"); ?>
								...
								<div class="row">
									...
									<div class="input-field col s12">
										<input id="CWID" type="number" class="validate" name="cwid" required min =" 1" max = "9999999" value="<?php echo $form->value("cwid"); ?>"><?php echo $form->error("cwid"); ?>
					...
					<div id="test2" class="col s12 deadlines">
						...
						<form action="adminprocess.php" method="POST" id="removedeadline">
							<select form="removedeadline" required name="number">
								<?php
							...
							<form action="adminprocess.php" method="POST">
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="input-field col s12">
											<input id="roomnumber" type="text" class="validate" name="name" required maxlength="30">
									...
									<div class="row">
										...
										<div class="input-field col s12">
											<input id="capacity" type="number" class="validate" name="cap" required min="0"  maxlength="30">
											<label for="capacity">Capacity</label>
										</div>
									</div>
									
									<div class="input-field col s12">
										<input id="description" type="text" required class="validate" name="desc">
					...
					<div id="test5" class="col s12 paddi">
						<form action="adminprocess.php" method="POST" id="addcourse">
							...
							<div class="input-field col s12">
								<input id="coursenumber" min="0" max="9999" type="number" class="validate" name="num" required maxlength="4">
								<label for="coursenumber">Course Number</label>
							</div>
							<div class="input-field col s12">
								<input id="coursename" type="text" required  class="validate" name="title" maxlength="30">
				...
				<div>
					<div class="card1 card">
						...
						<form action="adminprocess.php" method="POST" id="archive">
							...
							<button class="btn waves-effect waves-light" type="submit" onclick="return confirm('WARNING!!! THIS ACTION WILL REMOVE ALL DEADLINES, LOG DETAILS, AND INSTRUCTOR ASSOCIATIONS FROM SYSTEM!  CONTINUE?');">Archive & Reset
								<i class="material-icons right">send</i>
							</button>
						</form>
					</div>
